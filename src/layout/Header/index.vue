              ...
              <div class="row align-items-center">
                <div class="col-auto">
                  <img
                    ...
                    src="/src/assets/img/team/profile-picture-1.jpg"
            ...
            >
              <div class="row align-items-center">
                <div class="col-auto">
                  <img
                    alt="Image placeholder"
                    src="/src/assets/img/team/profile-picture-2.jpg"
                    class="avatar-md rounded"
                  />
                </div>
                <div class="col ps-0 ms-2">
            ...
            >
              <div class="row align-items-center">
                <div class="col-auto">
                  <img
                    alt="Image placeholder"
                    src="/src/assets/img/team/profile-picture-4.jpg"
                    class="avatar-md rounded"
                  />
                </div>
                <div class="col ps-0 ms-2">
            ...
            >
              <div class="row align-items-center">
                <div class="col-auto">
                  <img
                    alt="Image placeholder"
                    src="/src/assets/img/team/profile-picture-5.jpg"
                    class="avatar-md rounded"
                  />
                </div>
                <div class="col ps-0 ms-2">
