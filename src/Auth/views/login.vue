    ...
    <section class="main-section">
        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
            <div class="text-center text-md-center mb-4 mt-md-0">
                ...
                <p class="mb-0">You can log in with 3 user types:</p>
                <p class="mb-0">
                    1. Email: <strong>admin@volt.com</strong>
                    Password
                    <strong>secret</strong>
                </p>
                <p class="mb-0">
                    2. Email: <strong>creator@volt.com</strong>
                    Password
                    <strong>secret</strong>
                </p>
                <p class="mb-0">
                    3. Email: <strong>member@volt.com</strong> Password
                    <strong>secret</strong>
                </p>
                <p></p>
            </div>
            <form wire:submit.prevent="login" action="#" class="mt-4" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text" id="basic-addon2"><svg class="icon icon-xs text-gray-600"
                    ...
                    <div class="d-flex justify-content-between align-items-top mb-4">
                        ...
                        <div>
                            <a href="https://volt-pro-laravel-admin-dashboard.updivision.com/forgot-password"
            ...
            <div class="d-flex justify-content-center align-items-center mt-4">
                <span class="fw-normal">
                    Not registered?
                    <a href="https://volt-pro-laravel-admin-dashboard.updivision.com/sign-up" class="fw-bold">Create
                        account</a>
                </span>
            </div>
        </div>
