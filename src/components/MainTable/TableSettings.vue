      ...
      <div class="col-9 col-lg-8 d-md-flex">
        <div class="input-group me-2 me-lg-3 fmxw-300">
          <span class="input-group-text"><svg class="icon icon-xs" x-description="Heroicon name: solid/search"
            ...
            </svg> </span><input type="text" class="form-control" :placeholder="searchPlaceholder" v-model="search" />
        </div>
      </div>
        ...
        <div class="btn-group">
          <div class="dropdown me-1">
            ...
            <div class="dropdown-menu dropdown-menu-end pb-0">
              ...
              <a @click="$emit('setPerPage', 5)" role="button" class="dropdown-item d-flex align-items-center fw-bold"
                :class="{ active: perPage.number == 5 }">
                5
              </a>
              <a class="dropdown-item fw-bold" role="button" @click="$emit('setPerPage', 10)"
                :class="{ active: perPage.number == 10 }">
                10
              </a>
              <a class="dropdown-item fw-bold rounded-bottom" role="button" @click="$emit('setPerPage', 20)"
