<template>
  <div class="col-12 col-lg-6">
    ...
    <transition-group name="list" v-if="props.images" tag="div" class="row">
      <div class="image-container col-3" v-for="(image, index) in props.images" :key="image">
        ...
        <div class="image-card-footer">
          ...
          <button type="button" class="image-card-full-btn" @click="showFullScreenImage(image.image_url ?? defultImage)">
            <i class="fa-solid fa-up-right-and-down-left-from-center"></i>
          </button>
        </div>

        <div v-show="FormStore.errors[`productImages.${index}`]" v-for="err in FormStore.errors[`productImages.${index}`]"
