  ...
  <section class="main-section">
    <PageHeader :title="`Order`">
      <template #breadcrumbItem>
        <RouterLink :to="{ name: 'orders' }">Orders list</RouterLink>
      </template>
    </PageHeader>
      ...
      <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
          <div class="d-flex flex-column align-items-center">
            <h4 class="card-title">Order #{{ OrderDetailsStore.order.id }}</h4>
            <div class="d-flex">
              <p
      ...
      <div class="card-body">
          ...
          <table class="table table-centered table-nowrap mb-0 rounded">
            ...
            <tbody>
              <tr v-for="product in OrderDetailsStore.products">
                ...
                <td>
                  <span class="fw-normal">{{ product.product_price }} SAR</span>
                </td>
                <td>
                  <span class="fw-normal">{{ product.product_quantity }}</span>
                </td>
                <td>
        ...
        <div class="card text-bg-light mb-3 mt-5 w-100">
          ...
          >
            ...
            >
              <h6>subTOTAL</h6>
              <strong class="text-dark text-center" style="font-size: 0.875rem">
